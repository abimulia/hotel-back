...
public class SecurityUtils {
	...
	public static User mapOauth2AttributesToUser(Map<String, Object> attributes) {
		...
		if (attributes.get("email") != null) {
			...
			log.debug("email: " + attributes.get("email"));
		...
		if (attributes.get(CLAIMS_NAMESPACE) != null) {
			...
			log.debug("authoritiesRaw: " + authoritiesRaw);
	...
	private static Collection<String> getRolesFromClaims(Map<String, Object> claims) {
		...
		List<String> claimedByNamespace = (List<String>) claims.get(CLAIMS_NAMESPACE);
		log.debug("claimedByNamespace: " + claimedByNamespace);
		return claimedByNamespace;
	}
