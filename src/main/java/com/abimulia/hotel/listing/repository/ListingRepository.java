...
public interface ListingRepository extends JpaRepository<Listing, Long> {
	...
	Page<Listing> findAllByLocationAndBathroomsGreaterThanEqualAndBedroomsGreaterThanEqualAndGuestsGreaterThanEqualAndBedsGreaterThanEqual(Pageable pageable, String location,
